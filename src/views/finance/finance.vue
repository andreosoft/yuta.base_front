<template>
  <div>
    <h5 class="pt-3 pb-2 mb-0 border-bottom text-center">Список платежей</h5>
    <div class="comments-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover table-sm">
            ...
            <tbody>
              ...
              >
                <td>{{k+1}}</td>
                <td v-for="(el, key) in $store.getters['db/structure'].crm_finance" :key="key">
      ...
      <div v-else>
        <p class="mb-0 text-center">Нет платежей!</p>
        <p class="text-center">Тут вы можете создать платеж для данного контакта</p>
      </div>
...
import formDeal from "@/views/finance/form_finance.vue";

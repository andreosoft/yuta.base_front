        ...
        >
          <div class="flex-table-header">
            <div class="flex-table-row">
              <div class="flex-table-col sortable" :style="{width: $store.getters['db/width']('crm_contacts')+'%'}" @click="sortBy('id')">
                #
            ...
            <div class="flex-table-row" style="height: 44px;">
              <div class="flex-table-col" :style="{width: $store.getters['db/width']('crm_contacts')+'%'}">
                <input
                  class="form-control"
                  type="text"

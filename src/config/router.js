    ...
    },
    {
        ...
        },
        {
            ...
            },
            {
                ...
                component: () =>
                    import('@/views/contacts/calls.vue')
            },
            ]
        },
        ...
        },
        {
            ...
            meta: { 'title': 'Сделки', auth: [1, 50, 100] },
            redirect: to => {
                return { name: 'deals_finance' }
            },
            component: () =>
                import('@/views/deals/view.vue'),
            children: [{
                path: '/deals/:id/finance',
                name: 'deals_finance',
                meta: { title: 'Сделки', auth: [1, 50, 100] },
                component: () =>
                    import('@/views/finance/finance.vue')

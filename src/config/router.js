    ...
    },
    {
...

        {
            ...
            },
            {
                ...
                component: () =>
                    import('@/views/config/string/index.vue'),
                children: [{
                    path: '/config/string/list',
                    name: 'string_contacts',
                    meta: { 'title': 'Открыть настройки полей контактов', auth: [1, 50, 100] },
                    component: () =>
                        import('@/views/config/string/contacts.vue')
                },
                {
                    path: '/config/string/list',
                    name: 'string_deals',
                    meta: { 'title': 'Открыть настройки полей сделок', auth: [1, 50, 100] },
                    component: () =>
                        import('@/views/config/string/deals.vue')
                },
                {
                    path: '/config/string/list',
                    name: 'string_contacts',
                    meta: { 'title': 'Открыть настройки полей объектов', auth: [1, 50, 100] },
                    component: () =>
                        import('@/views/config/string/contacts.vue')
                },
                ]

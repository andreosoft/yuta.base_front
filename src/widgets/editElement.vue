<template>
  <div>
    ...
    <div v-else-if="el.type == 'date'">
      <input-select-date :label="el.name" @change="onChange" v-model="val" :error="error"></input-select-date>
    </div>
    <div v-else-if="el.type == 'ref' && el.data.field_view == 'contact'">
      <div class="form-group">
        <label>{{el.name}}</label>
        <div class="form-control" @click="select_client=true" style="cursor: pointer;">{{view}}</div>
        <transition name="slide-fade">
          <select-client
            v-if="select_client"
            @change="onChangeClient"
            @close-menu="select_client=false"
          ></select-client>
        </transition>
      </div>
    </div>
    <div v-else-if="el.type == 'ref' && el.data.field_view == 'user'">
      <div class="form-group">
        <label>{{el.name}}</label>
        <div class="form-control" @click="select_user=true" style="cursor: pointer;">{{view}}</div>
        <transition name="slide-fade">
    ...
    <div v-else-if="el.type == 'ref' && el.data.field_view == 'deal'">
      <div class="form-group">
        <label>{{el.name}}</label>
        <div class="form-control" @click="select_deal=true" style="cursor: pointer;">{{view}}</div>
        <transition name="slide-fade">
    ...
    <div v-else-if="el.type == 'ref' && el.data.field_view == 'apartment'">
      <div class="form-group">
        <label>{{el.name}}</label>
        <div class="form-control" @click="select_apart=true" style="cursor: pointer;">{{view}}</div>
        <transition name="slide-fade">
          <select-apartment
            v-if="select_apart"
            @change="onChangeApart"
            @close-menu="select_apart=false"
          ></select-apartment>
        </transition>
      </div>
    </div>
